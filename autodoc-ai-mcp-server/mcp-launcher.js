...
const CONFIG = {
  ...
  openai: {
    apiKey: process.env.OPENAI_API_KEY || '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', // Your OpenAI API key
    model: 'gpt-3.5-turbo', // gpt-4, gpt-4-turbo or 'gpt-3.5-turbo' for faster/cheaper option
  },
